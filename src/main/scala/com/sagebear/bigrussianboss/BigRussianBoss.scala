...
object BigRussianBoss extends App {
  ...
  private val legalScript = примеры(
    Пример(
      Клиент говорит "Приветствие",
      Оператор говорит "Приветствие",
      Клиент говорит "Цель своего визита",
      Оператор спрашивает "Место покупки товара",
      Клиент говорит "Купил в магазине",
      Оператор спрашивает "Устраивает ли качество товара",
      Клиент говорит "Не устраивает",
      Оператор спрашивает "Является ли товар технически сложным",
      Клиент говорит "Является",
      Оператор говорит "Информацию о возврате технически cложного товара",
      Клиент говорит "Прощание",
      Оператор говорит "Прощание",
    ),
    Пример(
      Клиент говорит "Приветствие",
      Оператор говорит "Приветствие",
      ...
      Клиент говорит "Не устраивает",
      Оператор спрашивает "Является ли товар технически сложным",
      Клиент говорит "Не является",
      Оператор говорит "Информацию о возврате технически не cложного товара",
      Клиент говорит "Прощание",
      Оператор говорит "Прощание",
    ),
    Пример(
      ...
      Оператор говорит "Информацию о возврате товара когда устраивает качество",
      Клиент говорит "Прощание",
      Оператор говорит "Прощание",
    ),
    Пример(
      ...
      Клиент говорит "Цель своего визита",
      Оператор спрашивает "Место покупки товара",
      Клиент говорит "Купил онлайн",
      Оператор говорит "Информацию о возврате товара при покупкe онлайн",
      Клиент говорит "Прощание",
      Оператор говорит "Прощание",
    )
  )
