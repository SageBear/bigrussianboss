...
object BigRussianBoss extends App {
  ...
  private val legalScript = примеры(
    Пример(
      ...
      Клиент   - Купил_в_магазине,
      Оператор - Устраивает_ли_качество_товара,
      Клиент   - Не_устраивает,
      Оператор - Является_ли_товар_технически_сложным,
      Клиент   - Является,
      Оператор - Информацию_о_возврате_технически_сложного_товара,
      Клиент прощается,
      Оператор прощается,
    ),
    Пример(
      ...
      Оператор - Является_ли_товар_технически_сложным,
      Клиент   - Не_является,
      Оператор - Информацию_о_возврате_технически_не_сложного_товара,
      Клиент прощается,
      Оператор прощается,
    ),
    Пример(
      ...
      Оператор - Устраивает_ли_качество_товара,
      Клиент   - Устраивает,
      Оператор - Информацию_о_возврате_товара_когда_устраивает_качество,
      Клиент прощается,
      Оператор прощается,
    ),
    Пример(
      ...
      Оператор - Место_покупки_товара,
      Клиент   - Купил_онлайн,
      Оператор - Информацию_о_возврате_товара_при_покупке_онлайн,
      Клиент прощается,
      Оператор прощается,
    )
  )
